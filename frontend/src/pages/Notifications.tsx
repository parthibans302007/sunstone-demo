...
const Notifications = () => {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Control Toolbar */}
      <div className="bg-card border border-border/60 p-4 rounded-2xl shadow-sm flex items-center justify-between text-xs font-bold">
        <div className="flex bg-muted/40 p-1 border rounded-xl gap-0.5 select-none">
          <button 
