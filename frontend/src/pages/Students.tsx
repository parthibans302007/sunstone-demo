...
import {
  Search, Plus, User, Mail, Phone, BookOpen, AlertCircle, X,
  Hash, LayoutGrid, List, ChevronLeft, ChevronRight, Upload,
  MapPin, Calendar, GraduationCap, Briefcase, Award, ClipboardCheck
} from "lucide-react";
